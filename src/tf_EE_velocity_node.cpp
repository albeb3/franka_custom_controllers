...
int main(int argc, char** argv){
    ...
    node.param("frame_id", frame_id_, std::string("panda_link0"));
    ...
    ROS_INFO("Waiting for panda_link0_T_panda_EE...");
    tfBuffer.canTransform("panda_link0", "panda_EE", ros::Time(0), ros::Duration(10.0));
    geometry_msgs::TransformStamped start_PandaLink0_T_PandaEE;
    try {
        start_PandaLink0_T_PandaEE = tfBuffer.lookupTransform("panda_link0", "panda_EE", ros::Time(0));
    }
